defmodule Ingot.Provisioner.Docker do
  @moduledoc """
  ...
  def boot(state) do
    ...
    cond do
      not Ingot.Provisioner.available?(:docker) ->
  ...
  def spawn_monitor(state, func), do: Ingot.Provisioner.Local.spawn_monitor(state, func)
