...
Support the development of **IngotCluster** and the distributed Elixir stack.
...
- **Zig NIF maintenance** — BLAKE3, XXH3, key-match
- **Iroh/Zenoh cluster stack** — libcluster strategies, discovery protocols
- **FLAME backend** — local/docker/fly/k8s/ec2 provisioners
